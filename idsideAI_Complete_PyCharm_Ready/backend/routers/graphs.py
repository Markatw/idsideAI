...
from idsideAI_Complete_PyCharm_Ready.backend.models.schemas import SubgraphResponse, DiffResponse, Node, Edge, Snapshot, DiffChange
...
def snapshots(graph_id: str, request: Request):
    return _load_snapshots_neo4j(graph_id, request.state.tenant_id, request.state.workspace_id)
