...
def sp_config():
    return {"patch": {"supported": True}, "filter": {"supported": True}, "bulk": {"supported": False}, "changePassword": {"supported": False}}
...
def create_user(userName: str = Body(...), givenName: str = Body(""), familyName: str = Body(""), email: str = Body("")):
