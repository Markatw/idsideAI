...
"""
Replace naive datetime.now(timezone.utc) with timezone-aware datetime.now(timezone.utc).
Adds 'from datetime import timezone' if missing.
Creates .bak backups for changed files.
Usage:
    python scripts/apply_timezone_fix.py .
"""
import re, sys
